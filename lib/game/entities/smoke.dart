...
class SmokeParticle extends PositionComponent {
  ...
  late final innerPos = PositionComponent(
    ...
    //   CircleComponent(
    //     radius: 10,
    //     paint: Paint()..color = const Color(0x88AA00AA),
    //     anchor: Anchor.center,
    //   ),
    // ],
  ...
  void update(double dt) {
    ...
    // (innerPos.children.first as PositionComponent).size = Vector2.all(
    //   10 + 400 * progress,
    // );
    // (innerPos.children.first as CircleComponent).opacity = (1.0 - progress);
